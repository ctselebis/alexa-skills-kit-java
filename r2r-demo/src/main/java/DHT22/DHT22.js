...
var config = {};
config.IOT_BROKER_ENDPOINT      = "a2dja98itbmec1.iot.us-east-1.amazonaws.com";
...
exports.handler = function (event, context) {
    try {
        ...
        if (event.session.application.applicationId !== "amzn1.ask.skill.bb2ceeed-e235-46a7-bdd4-f5cb78cbd862") {
...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "Welcome to Planet Liferay Weather, Where I communicate with some sensors from a raspberry pie," + 
...
function handleSessionEndRequest(callback) {
    ...
    var speechOutput = "Thank you for visiting Planet Liferay Weather, Have an amazing day!";
