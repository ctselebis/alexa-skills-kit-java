...
public class PlanetLiferay2HealthSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(PlanetLiferay2HealthSpeechlet.class);
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        if ("LiferayHealth".equals(intentName)) {
	        try {
	...
	private SpeechletResponse getHealthStatusResponse() throws IOException{
		...
		credsProvider.setCredentials(
			new AuthScope("cloud-10-0-20-50.liferay.com", 80),
			creds);
		...
		try {
			HttpGet httpGet = new HttpGet("https://cloud-10-0-20-50.liferay.com/c/portal/health");
